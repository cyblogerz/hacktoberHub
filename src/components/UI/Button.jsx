...
const Button = ({lang}) => { 
  ...
  <button
    className='relative p-6  btn btn-lg text-white rounded-2xl leading-none transition duration-300 ring-2 ring-transparent hover:ring-blue-500 hover:shadow-md'
  >
    {lang}
  </button>
</div>
